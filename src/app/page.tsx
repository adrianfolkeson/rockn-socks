...
const products: Product[] = [
  ...
  { id: 5, name: 'Enhörning Sockor', category: 'animals', price: 49, originalPrice: 49, image: '/products/unicorn-socks.jpg', rating: 4.8, reviews: 189, variants: [{size: '34-36', stock: 18}, {size: '37-39', stock: 22}, {size: '40-42', stock: 20}, {size: '43-45', stock: 15}] },
      ...
      <div className="relative bg-white rounded-t-3xl sm:rounded-2xl p-6 sm:p-8 w-full max-w-sm shadow-2xl sm:mt-0 mt-auto sm:mb-auto">
        ...
        <div className="space-y-4">
          <input
            ...
            onChange={(e) => setEmail(e.target.value)}
            placeholder="E-post"
            className="w-full px-4 py-3.5 rounded-xl border border-slate-200 text-slate-900 text-base focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none min-h-[48px]"
          />
          <input
            type="password"
            value={password}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-sm sm:text-base text-pink-600 font-bold mb-6 sm:mb-8">
                5% av vinsten går till Svenska Down Föreningen
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              <img 
                src="/gruppbild.png" 
                alt="Svenska Down Föreningen gruppbild" 
                ...
                answer={
                  faq.q === 'Reklamation' ? (
                    <>
                      ...
                      <br />
                      <span className="text-xs text-slate-500">(Reklamation sker endast vid fabriskfel eller felaktig leverans)</span>
                    </>
                  ) : faq.a
                } 
              />
